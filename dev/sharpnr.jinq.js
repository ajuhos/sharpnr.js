/* JINQ Library
 * Extends JavaScript with useful collection manipulation functions and lambda expressions.
 * by Balázs Svarczkopf
 * 2012.05.17.
 * v1.0 beta
 */
...
Functions:
- Array JINQ.range(n, [from])
- Array JINQ.sequence(rule, n, [from])
- void String.lambda([params...], [context])
- Function String.parseLambda([context])
- num Array.randomIndex([min], [max])
- item Array.random([predicate])
- item Array.min([selector])
- item Array.max([selector])
- num Array.sum([selector])
- Array Array.take(n, [from])
- bool Array.contains(item)
- Array Array.select(selector)
- Array Array.where(predicate)
- item Array.single([predicate])
- item Array.first([predicate])
- item Array.last([predicate])
- Array Array.reverse() [override]
- Array Array.combine(selector, Array arrays...)
- Array Array.groupby(selector)
- Array Array.orderby([selector])
- void Array.foreach(action)
- Array Array.attach(Object context...)
- multiple Array.attached([selector])
- Array Array.concat(multiple itemsOrArrays...) [override]
*/
